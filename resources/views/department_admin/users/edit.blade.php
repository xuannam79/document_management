                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group date birthday">
                                    {!! Form::text('birth_date', (new DateTime($user->birth_date))->format('d/m/Y'), ['data-date-format'=>'dd/mm/yyyy','readonly', 'class'=>'form-control', 'style'=>'background:#fff']) !!}
                                </div>
                                {!! Form::label('gender', "Giới Tính") !!}
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        {!! Form::select('gender' , [config('setting.gender.male') => 'Nam', config('setting.gender.female') => 'Nữ'], $user->gender, ['class' => 'form-control', 'id' => 'gender']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        {!! Form::text('phone', $user->phone, ['class' => 'form-control', 'placeholder' => "Nhập Số Điện Thoại", 'id' => 'phone', 'pattern' => '[0][0-9]{9}',  'title' => 'số điện thoại chỉ gồm số và bắt đầu bằng số 0 , gồm 10 số.']) !!}
                                    </div>
                                </div>
