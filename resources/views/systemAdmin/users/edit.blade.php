            ...
            <div class="col-lg-6 col-ml-12">
                <div class="row">
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                    {!! Form::open(['method'=>'PUT', 'file'=>'true', 'route'=>['users.update',$user->id]]) !!}
                                {!! Form::label('email', "Email") !!}
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        {!! Form::email('email', $user->email, ['class' => 'form-control', 'placeholder' => "Nhập Email", 'id' => 'email']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        {!! Form::text('name', $user->name, ['class' => 'form-control', 'placeholder' => "Nhập  tên thành viên", 'id' => 'name']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        {!! Form::text('address', $user->address, ['class' => 'form-control', 'placeholder' => "Nhập địa chỉ", 'id' => 'address']) !!}
                                    </div>
                                </div>
