...
//    }
    ...
    public function index()
    {
        ...
        $document = DB::table('documents')->join('document_types', 'documents.document_type_id', '=', 'document_types.id')
            ...
            ->select('document_user.created_at as sent_date' , 'document_user.*', 'documents.*', 'documents.id as documentID', 'document_types.name as name_type_document', 'users.*', 'departments.name as name_department')
